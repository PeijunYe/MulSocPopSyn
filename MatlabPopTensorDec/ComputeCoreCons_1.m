function core = ComputeCoreCons_1(origTensor,U_1,U_2,U_3,U_4)

% this function computes the first constraint to the core
% the result covers dimension 1 to 4, that is:
% gender * resideProv * resideType * ageInter

MP_pseudo_inverse_1 = inv(U_1);
Constraint_1 = zeros(2,31,3,21);
for dim_2=1:31
	for dim_3=1:3
		for dim_4=1:21
			for i=1:2
